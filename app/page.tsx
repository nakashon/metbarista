...
import { Coffee, Gauge, History, ArrowRight, Layers, GitCompare, Radio, Share2 } from "lucide-react";
...
const FEATURES = [
  {
    icon: Gauge,
    title: "Control Plane",
    desc: "Preheat, tare, purge, start/stop — full machine control from your browser.",
    color: "#e8944a",
  },
  {
    icon: History,
    title: "Shot Analytics",
    desc: "Full history with pressure, flow, weight and temperature curves per extraction.",
    color: "#60a5fa",
  },
  {
    icon: Layers,
    title: "Profile Library",
    desc: "Browse your machine's profiles with OEPF stage diagrams and settings.",
    color: "#a78bfa",
  },
  {
    icon: Radio,
    title: "Live Monitor",
    desc: "Watch your extraction in real-time via Socket.IO telemetry streaming.",
    color: "#f87171",
  },
  {
    icon: GitCompare,
    title: "Shot Comparison",
    desc: "Overlay up to 5 shots to analyse consistency and dial-in improvements.",
    color: "#34d399",
  },
  {
    icon: Share2,
    title: "Geeky Share Cards",
    desc: "Share profiles with actual shot telemetry, curves, and full OEPF data.",
    color: "#f5a855",
  },
];
      ...
      <section className="mx-auto max-w-5xl px-6 py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {FEATURES.map(({ icon: Icon, title, desc, color }) => (
            <div
              key={title}
              className="group rounded-2xl border border-white/[0.06] bg-[#161210] p-5 hover:border-white/[0.12] hover:bg-[#1e1b16] transition-all"
            >
              <div
